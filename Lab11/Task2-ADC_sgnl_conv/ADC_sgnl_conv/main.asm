...
start:
	...
	ldi r16, 0x04	;set PE1 as input
	sts PORTE_PIN1CTRL, r16

	ldi r16, 0x01	;set ADC mode
	sts ADC0_CTRLA, r16

	ldi r16, 0x05	;set prescaler
	sts ADC0_CTRLC, r16

	ldi r16, 0x09	;pick the analog input
	sts ADC0_MUXPOS, r16
...
toggle_pin_ISR:
	push r16	;save registers to a stack
	in r16, CPU_SREG
	push r16
	push r17
	push r18
	...
	rcall multiplex_display	;call multiplex subroutine
...
signal_conv:
	...
	rcall hex_to_7seg	;call converstion subroutine
	st X+ ,r18	;store value in led_display

	mov r18, r15	;same as before
	rcall hex_to_7seg
	st X+,r18
